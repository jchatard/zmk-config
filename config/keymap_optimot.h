...
#define OP_DCIR SINGLE_QUOTE // ^
#define OP_Z    BACKSLASH // Z
// Row 4
#define OP_K    NON_US_BACKSLASH // K
#define OP_Y    Z    // Y
#define OP_EGRV X    // È
#define OP_DOT  C    // .
#define OP_W    V    // W
#define OP_DEL  BACKSPACE // Backspace
#define OP_G    N    // G
#define OP_C    M    // C
#define OP_M    KP_COMMA // M
#define OP_H    DOT  // H
#define OP_V    KP_SLASH // V
...
#define OP_4    LS(OP_LPRN) // 4
#define OP_5    LS(OP_RPRN) // 5
#define OP_6    LS(OP_PERC) // 6
#define OP_7    LS(OP_PLUS) // 7
#define OP_8    LS(OP_MINS) // 8
#define OP_9    LS(OP_EQL)  // 9
#define OP_0    LS(OP_SLSH) // 0
#define OP_UNDS LS(OP_ASTR) // _
#define OP_MORD LS(OP_HASH) // º
// Row 2
...
#define OP_AT   LA(OP_PERC) // @
#define OP_PLMN LA(OP_PLUS) // ±
#define OP_MMNS LA(OP_MINS) // −
